...
const MEAL_PLACEHOLDER_SRC = 'assets/icons/meal.jpg';
const MEAL_PLACEHOLDER_HTML = `<img class="nl-meal-card-img" src="${MEAL_PLACEHOLDER_SRC}" alt="" decoding="async">`;
...
function _mealCardImg(m) {
  if (m.image && _isCloudMarker(m.image)) {
    ...
    return `<img class="nl-meal-card-img" src="${m.image}" alt="" decoding="async" onerror="this.onerror=null;this.src='${MEAL_PLACEHOLDER_SRC}'">`;
  }
  return MEAL_PLACEHOLDER_HTML;
}
