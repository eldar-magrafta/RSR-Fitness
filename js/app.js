...
window.nlOpenQuickAdd = nlOpenQuickAdd;
window.nlCloseQuickAdd = nlCloseQuickAdd;
window.nlQuickFillCalFromMacros = nlQuickFillCalFromMacros;
window.nlSaveQuickAdd = nlSaveQuickAdd;
