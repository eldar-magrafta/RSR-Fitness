...
// Meal-time slots. Order defines diary grouping order.
export const MEAL_SLOTS = ['breakfast', 'lunch', 'dinner', 'snack'];
export const MEAL_SLOT_LABELS = { breakfast: 'Breakfast', lunch: 'Lunch', dinner: 'Dinner', snack: 'Snack' };
export const MEAL_SLOT_ICONS = { breakfast: '🌅', lunch: '☀️', dinner: '🌙', snack: '🍎' };

/** Default meal slot based on current hour of day. */
export function defaultMealSlot() {
